...
void CEC17::test_func(double *x, double *f, int mx) {
	...
	for (i = 0; i < mx; i++) {
		switch(func_flag) {
			case 1:
				bent_cigar_func(&x[i*n_flag],&f[i],n_flag,OShift,M,1,1);
				f[i]+=100.0;
				break;
			case 2:
				sum_diff_pow_func(&x[i*n_flag],&f[i],n_flag,OShift,M,1,1);
				f[i]+=200.0;
				break;
			case 3:
				zakharov_func(&x[i*n_flag],&f[i],n_flag,OShift,M,1,1);
				f[i]+=300.0;
				break;
			case 4:
				rosenbrock_func(&x[i*n_flag],&f[i],n_flag,OShift,M,1,1);
				f[i]+=400.0;
				break;
			case 5:
				rastrigin_func(&x[i*n_flag],&f[i],n_flag,OShift,M,1,1);
				f[i]+=500.0;
				break;
			case 6:
				schaffer_F7_func(&x[i*n_flag],&f[i],n_flag,OShift,M,1,1);
				f[i]+=600.0;
				break;
			case 7:
				bi_rastrigin_func(&x[i*n_flag],&f[i],n_flag,OShift,M,1,1);
				f[i]+=700.0;
				break;
			case 8:
				step_rastrigin_func(&x[i*n_flag],&f[i],n_flag,OShift,M,1,1);
				f[i]+=800.0;
				break;
			case 9:
				levy_func(&x[i*n_flag],&f[i],n_flag,OShift,M,1,1);
				f[i]+=900.0;
				break;
			case 10:
				schwefel_func(&x[i*n_flag],&f[i],n_flag,OShift,M,1,1);
				f[i]+=1000.0;
				break;
			case 11:
				hf01(&x[i*n_flag],&f[i],n_flag,OShift,M,SS,1,1);
				f[i]+=1100.0;
				break;
			case 12:
				hf02(&x[i*n_flag],&f[i],n_flag,OShift,M,SS,1,1);
				f[i]+=1200.0;
				break;
			case 13:
				hf03(&x[i*n_flag],&f[i],n_flag,OShift,M,SS,1,1);
				f[i]+=1300.0;
				break;
			case 14:
				hf04(&x[i*n_flag],&f[i],n_flag,OShift,M,SS,1,1);
				f[i]+=1400.0;
				break;
			case 15:
				hf05(&x[i*n_flag],&f[i],n_flag,OShift,M,SS,1,1);
				f[i]+=1500.0;
				break;
			case 16:
				hf06(&x[i*n_flag],&f[i],n_flag,OShift,M,SS,1,1);
				f[i]+=1600.0;
				break;
			case 17:
				hf07(&x[i*n_flag],&f[i],n_flag,OShift,M,SS,1,1);
				f[i]+=1700.0;
				break;
			case 18:
				hf08(&x[i*n_flag],&f[i],n_flag,OShift,M,SS,1,1);
				f[i]+=1800.0;
				break;
			case 19:
				hf09(&x[i*n_flag],&f[i],n_flag,OShift,M,SS,1,1);
				f[i]+=1900.0;
				break;
			case 20:
				hf10(&x[i*n_flag],&f[i],n_flag,OShift,M,SS,1,1);
				f[i]+=2000.0;
				break;
			case 21:
				cf01(&x[i*n_flag],&f[i],n_flag,OShift,M,1);
				f[i]+=2100.0;
				break;
			case 22:
				cf02(&x[i*n_flag],&f[i],n_flag,OShift,M,1);
				f[i]+=2200.0;
				break;
			case 23:
				cf03(&x[i*n_flag],&f[i],n_flag,OShift,M,1);
				f[i]+=2300.0;
				break;
			case 24:
				cf04(&x[i*n_flag],&f[i],n_flag,OShift,M,1);
				f[i]+=2400.0;
				break;
			case 25:
				cf05(&x[i*n_flag],&f[i],n_flag,OShift,M,1);
				f[i]+=2500.0;
				break;
			case 26:
				cf06(&x[i*n_flag],&f[i],n_flag,OShift,M,1);
				f[i]+=2600.0;
				break;
			case 27:
				cf07(&x[i*n_flag],&f[i],n_flag,OShift,M,1);
				f[i]+=2700.0;
				break;
			case 28:
				cf08(&x[i*n_flag],&f[i],n_flag,OShift,M,1);
				f[i]+=2800.0;
				break;
			case 29:
				cf09(&x[i*n_flag],&f[i],n_flag,OShift,M,SS,1);
				f[i]+=2900.0;
				break;
			case 30:
				cf10(&x[i*n_flag],&f[i],n_flag,OShift,M,SS,1);
				f[i]+=3000.0;
				break;
			default:
