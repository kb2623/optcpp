...
class DE: public ParallelSearchAlgorithm<double>, public CooperativeCoevolutionOptimizer, public DeMutations {
public:
	DE();
	DE(size_t);
	DE(size_t, size_t);
...
protected:
	vector<double*> pop;
	vector<double> popf;
	std::function<double(DE&, int, double*)> opt = &DE::rand_1;
